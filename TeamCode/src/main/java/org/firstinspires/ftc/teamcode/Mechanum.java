...
public class Mechanum extends OpMode {
    ...
    public void init() {
        ...
        // app.
        front_left   = hardwareMap.get(DcMotor.class, "driveFL");
        front_right  = hardwareMap.get(DcMotor.class, "driveFR");
        back_left    = hardwareMap.get(DcMotor.class, "driveRL");
        back_right   = hardwareMap.get(DcMotor.class, "driveRR");
